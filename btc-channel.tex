...
Bitcoin}
\author{Thomas Shababi\inst{1} \and Jo\"el Gugger\inst{2} \and Daniel
Lebrecht\inst{1}}
\authorrunning{Thomas~S.~Shababi et al.}
\tocauthor{Thomas~S.~Shababi, Joel Gugger, and Daniel Lebrecht}
\subtitle{{\normalsize\today{\small\ -- DRAFT}}}
\institute{DigiThink, Neuch\^atel, Switzerland\\ \email{info@digithink.ch} \and
HES-SO Master, Lausanne, Switzerland\\ \email{joel.gugger@master.hes-so.ch} }
